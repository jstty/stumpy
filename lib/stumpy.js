...
function Stumpy(opts, opts2) {
    ...
    if(opts) {
        ...
        if(isObject(opts)){
            ...
            if(opts.hasOwnProperty('_getTrace')) {
                if(typeof opts._getTrace === 'boolean') {
                    this._options._getTrace = opts._getTrace;
                }
            }
            ...
            if(opts.hasOwnProperty('showTrace')) {
                if(typeof opts.showTrace === 'boolean') {
                    ...
                    if(!this._options._getTrace){
                        this._options._getTrace = true;
                    }
                }
            }
            ...
            if(opts.hasOwnProperty('buffer')) {
                ...
                if( this._options.buffer.showTrace &&
                    !this._options.buffer._getTrace){
                    this._options.buffer._getTrace = true;
                }
            }
        }
    }
...
Stumpy.prototype._addLogType = function(type) {
    ...
    Stumpy.prototype[type] = function Logger(){
        ...
        if(this._options.display[type]){
            ...
            if(this._options._getTrace || log.type === 'trace') {
        ...
        if(this._options.buffer.size > 0) {
            ...
            if( !log.stackTrace &&
                (this._options.buffer._getTrace || log.type === 'trace')) {
                log.stackTrace = this._getTrace();
            }
